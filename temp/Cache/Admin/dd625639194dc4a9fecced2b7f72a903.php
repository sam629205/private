...
<div class="topnav">
  ...
  <div class="leftnav">
    <ul>
      <li class="navleft"></li>
      <li id="d1" style="margin-left: -1px" class="thisclass"  onClick="ConClass(1);"><a href="?s=Admin/Index/main" target="main" onClick="left('?s=Admin/Index/Left/id/config');">系统设置</a></li>
